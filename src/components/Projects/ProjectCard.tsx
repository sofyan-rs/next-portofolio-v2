  ...
  return (
    <>
      <div className="flex flex-col justify-between rounded-md border-red-400 bg-white shadow-sm transition-all hover:-translate-y-2 hover:border-t-4 hover:shadow-md dark:bg-slate-700">
        <h3 className="p-4 text-lg font-bold">{project.title}</h3>
        <Image
          className="h-48 w-full overflow-hidden border-y border-slate-100 object-cover object-top dark:border-slate-600 md:h-44 lg:h-56 xl:h-44 2xl:h-56"
