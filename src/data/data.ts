...
export const aboutMe =
  "I’m graduated from Electronics Engineering ⚡, but because my passion now currently working as Frontend Developer 👨‍💻. I’m usually make project using React.js, NextJS, Wordpress, and React Native.";
...
export const myProjects = [
  ...
  },
  {
    ...
    description:
      "Automatic Sluice Gate Simulation Control and Monitoring System Based on Internet of Things. Created using ESP32, Vanilla JS, PHP, MySQL, and Firebase.",
  ...
  },
  {
    title: "Web HME",
    description:
      "Website for Polban Electronics Student Association (HME). Created using Wordpess.",
    image: "web-hme.png",
  ...
  },
  {
    title: "E-Vote HME",
    description:
      "Website for the Election of the Chairman of the Polban Electronics Student Association (HME). Created using PHP and MySQL.",
  ...
  },
  {
    ...
    description:
      "Website for Polban Electronics Engineering Final Project Exhibition. Created using Wordpess.",
